...
Future<void> initApp() => RustLib.instance.api.spartan2HyraxMoproInitApp();
...
Future<String> setupPrepareKeys({
  ...
  String? inputPath,
}) => RustLib.instance.api.spartan2HyraxMoproSetupPrepareKeys(
...
Future<String> setupShowKeys({
  required String documentsPath,
  String? inputPath,
}) => RustLib.instance.api.spartan2HyraxMoproSetupShowKeys(
  documentsPath: documentsPath,
  inputPath: inputPath,
);
...
Future<String> generateSharedBlinds({required String documentsPath}) => RustLib
    .instance
    .api
    .spartan2HyraxMoproGenerateSharedBlinds(documentsPath: documentsPath);
...
Future<ProofResult> provePrepare({
  required String documentsPath,
  String? inputPath,
}) => RustLib.instance.api.spartan2HyraxMoproProvePrepare(
  documentsPath: documentsPath,
  inputPath: inputPath,
);
...
Future<ProofResult> proveShow({
  required String documentsPath,
  String? inputPath,
}) => RustLib.instance.api.spartan2HyraxMoproProveShow(
  documentsPath: documentsPath,
  inputPath: inputPath,
);
...
Future<ProofResult> reblindPrepare({required String documentsPath}) => RustLib
    .instance
    .api
    .spartan2HyraxMoproReblindPrepare(documentsPath: documentsPath);
...
Future<ProofResult> reblindShow({required String documentsPath}) => RustLib
    .instance
    .api
    .spartan2HyraxMoproReblindShow(documentsPath: documentsPath);
...
Future<bool> verifyPrepare({required String documentsPath}) => RustLib
    .instance
    .api
    .spartan2HyraxMoproVerifyPrepare(documentsPath: documentsPath);

/// Verify Show circuit proof
/// Verifies the proof using the verifying key
Future<bool> verifyShow({required String documentsPath}) => RustLib.instance.api
    .spartan2HyraxMoproVerifyShow(documentsPath: documentsPath);
...
Future<BenchmarkResults> runCompleteBenchmark({
  required String documentsPath,
  String? inputPath,
}) => RustLib.instance.api.spartan2HyraxMoproRunCompleteBenchmark(
  documentsPath: documentsPath,
  inputPath: inputPath,
);
...
}) => RustLib.instance.api.spartan2HyraxMoproGetCommWShared(
  documentsPath: documentsPath,
...
Future<String> moproHelloWorld() =>
    RustLib.instance.api.spartan2HyraxMoproMoproHelloWorld();
...
class BenchmarkResults {
  ...
  static Future<String> formatSize({required BigInt bytes}) => RustLib
      .instance
      .api
      .spartan2HyraxMoproBenchmarkResultsFormatSize(bytes: bytes);
