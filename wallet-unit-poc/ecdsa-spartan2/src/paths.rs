...
//!
//! This module provides a `PathConfig` struct that encapsulates all path resolution logic,
//! making it explicit and thread-safe. Instead of relying on global working directory changes,
//! paths are resolved relative to a configured base directory.
